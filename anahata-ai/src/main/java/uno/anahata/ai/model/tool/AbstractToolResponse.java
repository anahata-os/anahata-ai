 ...
 * The fields are populated by the {@link #execute(uno.anahata.ai.model.tool.AbstractTool)} method.
 * @author pablo
 */
@Getter
public abstract class AbstractToolResponse<C extends AbstractToolCall, T extends AbstractTool<C, ?>> extends Part {
     ...
     */
    public abstract C getInvocation();
    
    /**
     * Executes the tool logic. This method is responsible for populating
     * the status, result, error, and executionTimeMillis fields.
     * @param tool The tool definition containing the executable logic.
     */
    public abstract void execute(T tool);
